...
export const RadicalDetail: FC<RadicalDetailProps> = ({ isOpen, onClose, item }) => {
  ...
  return (
    <DetailDrawer isOpen={isOpen} onClose={onClose} title={t('common:navigation.radicals')}>
        ...
        <div className={styles.hero}>
          ...
          <div className={styles.info}>
            <div className={styles.titleGroup}>
              ...
              <span className={styles.jaName}>({item.name.ja})</span>
            </div>
        ...
        {item.variants && item.variants.length > 0 && (
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              ...
              {t('kanji:detail.variants', { variants: '' }).replace(':', '').trim() || 'Biến thể'}
            </div>
